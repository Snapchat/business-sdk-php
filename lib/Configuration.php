...
use SnapBusinessSDK\Util\CustomHeaderTrait;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://tr.snapchat.com';
    ...
    {
        $report  = 'PHP SDK (SnapBusinessSDK) Debug Report:' . PHP_EOL;
